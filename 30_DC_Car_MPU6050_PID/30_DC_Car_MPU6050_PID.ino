...
//Sensor readings with offsets:  8 -4  16372 2 -1  -1
//Your offsets: -644  -4020 3579  310 72  8
//
//Data is printed as: acelX acelY acelZ giroX giroY giroZ
//Sensor readings with offsets:  2 0 16371 1 0 -1
//Your offsets: -644  -4019 3575  310 72  8
//
//Data is printed as: acelX acelY acelZ giroX giroY giroZ
//Sensor readings with offsets:  -1  3 16392 1 -1  0
//Your offsets: -643  -4020 3568  310 72  8

    mpu.setXGyroOffset(310);
    mpu.setYGyroOffset(72);
    mpu.setZGyroOffset(8);
    mpu.setZAccelOffset(3568);
